...
export default function RosterView() {
  ...
  // Deep link: /roster?new opens the editor directly (e.g. from the
  // "Create a player" CTA on /rooms). Consume the param once so refreshes
  // and back-nav don't reopen the form. Deferred to the next frame so the
  // editor opens after mount rather than synchronously inside the effect.
  ...
  useEffect(() => {
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps -- one-shot on the ?new param
  }, [searchParams]);
