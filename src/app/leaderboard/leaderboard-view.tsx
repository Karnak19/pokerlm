...
type Movers = (typeof api.leaderboard.movers._returnType);
type SparkData = (typeof api.leaderboard.historyMany._returnType);
...
export default function LeaderboardView({
  ...
  // The leaderboard is intentionally NOT live-reactive — page is cached
  // server-side. `me` stays a client query because it's tiny, auth-scoped,
  // and lets the "Your peak rank" cell stay accurate per viewer.
  const me = useQuery(api.users.me);
  const rows = initialRows;
  const movers = initialMovers;
  const sparkData = initialSparkData;
                ...
                return (
                  ...
                  >
                    ...
                    <div className="grid gap-1.5 border-y border-white/10 py-3.5">
                      ...
                      <RatingSparkline points={sparkData?.[r.playerId]} className="block h-[38px] w-full" />
            ...
            return (
              ...
              >
                ...
                <div className="hidden items-center gap-2.5 lg:flex">
                  <RatingSparkline points={sparkData?.[r.playerId]} className="h-7 w-full max-w-[110px]" />
                  {(() => {
